...
/*	@Test(priority = 2, description = "Verify the Resourceful category")
...
*/	
	...
	driver.manage().timeouts().implicitlyWait(40, TimeUnit.SECONDS);
	Thread.sleep(20000);
	WebElement privacyof = driver.findElement(By.xpath("//div[@id='content']//a[2]"));
	scrollIntoView(privacyof, driver);
	// share article
	WebElement elem = driver.findElement(By.xpath("//div[@id='content']//a[2]"));
	((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView();", elem);
	((JavascriptExecutor) driver).executeScript("arguments[0].click();", elem);
	driver.manage().timeouts().implicitlyWait(40, TimeUnit.SECONDS);
	Thread.sleep(10000);
